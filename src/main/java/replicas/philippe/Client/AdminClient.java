...
public class AdminClient extends ParticipantClient {
    ...
    public static Admin createAdmin(String city) throws MalformedURLException {
        URL url = new URL(String.format("http://localhost:%d/admin-%s?wsdl", ports.get(city), city));
        QName qName = new QName("http://Server.philippe.replicas/", "AdminImplService");
        Service service = Service.create(url, qName);
        return service.getPort(Admin.class);
    }
