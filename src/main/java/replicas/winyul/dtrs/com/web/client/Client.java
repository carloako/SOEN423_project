package replicas.winyul.dtrs.com.web.client;
import java.net.URL;
	...
	public static void main(String args[]) throws Exception {
		try {
			...
			*/
			...
			QName montrealqname=new QName("http://service.web.com.dtrs.winyul.replicas/","DTRSWebServicesImplService");
			montrealService=Service.create(montrealurl,montrealqname);
			
			URL torontourl= new URL("http://localhost:8081/toronto?wsdl");
			QName torontoqname=new QName("http://service.web.com.dtrs.winyul.replicas/","DTRSWebServicesImplService");
			torontoService=Service.create(torontourl,torontoqname);
			
			URL vancouverurl= new URL("http://localhost:8081/vancouver?wsdl");
			QName vancouverqname=new QName("http://service.web.com.dtrs.winyul.replicas/","DTRSWebServicesImplService");
